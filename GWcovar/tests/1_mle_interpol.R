...
result1.2 <- matrix(NA, n_k, n_m)
result1.3 <- matrix(NA, n_k, n_m)
...
tol0 <- tolerance*length(result1.2)
tol1 <- tolerance*length(result1.3)


if ( sum( result1.2 != 0 ) > tol0 || sum( result1.3 != 0 ) > tol1 ) { 
